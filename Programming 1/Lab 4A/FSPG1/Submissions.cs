...
namespace FSPG1
{
    ...
    public class Submissions
    {
        ...
        {
            if (operation == MathOperator.Add)
                return number1 + number2;
            else if (operation == MathOperator.Subtract)
                return number1 - number2;
            else if (operation == MathOperator.Multiply)
                return number1 * number2;
            else if (operation == MathOperator.Divide)
                return number1 / number2;
            else if (operation == MathOperator.Modulo)
                return number1 % number2;
            else
            return 0;
        }
        ...
        {
            if (kiloToLb == true)
                return Math.Round((input * 2.20462),3);
            if (kiloToLb == false)
                return Math.Round(( input *0.453592),3);
            else
            return 0;
        }
