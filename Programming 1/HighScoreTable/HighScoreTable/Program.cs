...
namespace HighScoreTable
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("How many high scores would you like to input?");
                Int32.TryParse(Console.ReadLine(), out Scores);
                if (Scores > 0)
            ...
            Console.Write("What do you want to enter for a high score? ");
            int x = 0;
        ...
        {
        foreach (int HighScore in numbers )
